...
class CreateNewPostState extends State<CreateNewPost> {
  ...
  Widget _conditionIcon(IconData icon, Color color,
      final ValueNotifier<bool> moodPressed, bool btnStat, String btnType) {
      ...
      child: Table(
        ...
        children: [
          TableRow(children: [
            ...
            TableCell(
                child: Center(
              child: _conditionIcon(TablerIcons.mood_neutral, Color(0XFFFE9E12),
                  how_neutralClick, how_neutral_stat, how_neutral),
            )),
            TableCell(
                child: Center(
              child: _conditionIcon(TablerIcons.mood_neutral, Colors.redAccent,
                  how_sadClick, how_sad_stat, how_sad),
            )),
          ]),
          TableRow(children: [
  ...
  void _postBtn() async {
    ...
    LocationData locationData =
        new LocationData(locationUID: widget.locationUID);
    PostData postData = new PostData();
    String postUID = await postData.createPost(
        userUID, widget.locationUID, contentsController.text, imageURL, mood);
