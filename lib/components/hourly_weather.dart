  ...
  Widget Collapsed(){
    return Container(
        child: Row(
            ...
            children: <Widget>[
              Text(
                  weatherInfo.getHour(widget.time),
                  style: TextStyle(
                    fontSize: 10,
              ...
              SizedBox(width:10),
              Image.asset(
                'assets/weather-' +  weatherInfo.getWeatherCondition(widget.weatherCode).toLowerCase() +'.png',
                height: 50,
                width: 50,
              ),
              SizedBox(width:5),
              Column(
                  ...
                  children:[
                    ...
                    Text(
                        weatherInfo.getWeatherCondition(widget.weatherCode),
                        style:TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 13,
                            color: _textcolor
              ...
              Column(
                children: [
                  Text("Chance of rain",style:TextStyle(fontSize:12, color: _textcolor)),
                  Row(
                    children: [
                      Image.asset(
  ...
  Widget ExpandedWidget(){
    return Container(
        ...
        child:Row(
          ...
          children: [
            Image.asset(
              'assets/wind-' + weatherInfo.getWindDirection(widget.windDegree)
                  .toUpperCase() +
                  '.png',
              height: 20,
              width: 20,
            ...
            Column(
              ...
              children: [
                ...
                Text(widget.humidity.toString()+"%", style: TextStyle( fontSize: 13))
              ],
            ),
            // Image.asset(
