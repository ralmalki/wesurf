...
class LocationData {
  ...
  void updateDanger() async {
    ...
    if (locationSnapshot['bluebottle'] >= 2 || locationSnapshot['current'] >= 2
        || locationSnapshot['shark'] >= 2 || locationSnapshot['uv'] >= 2
        ||locationSnapshot['wave'] >= 2 || locationSnapshot['wind'] >= 2) {
